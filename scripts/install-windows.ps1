# install-windows.ps1 - copy the m4l-chord-progression device folder into the Ableton
# User Library (Max For Live/m4l-chord-progression), replacing any previous install.
#
...
$deviceName = "m4l-chord-progression"
$amxdFile = "alienmind-chord-progression-m4l.amxd"

# Source: ./m4l-chord-progression next to this script (zip layout) or ../dist/m4l-chord-progression (repo layout).
