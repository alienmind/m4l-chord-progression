#!/bin/sh
# install-mac.sh - copy the m4l-chord-progression device folder into the Ableton
...
set -eu
device="m4l-chord-progression"
amxd_file="alienmind-chord-progression-m4l.amxd"
